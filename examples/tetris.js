...
function tetronimo(rects, skipCol) {
  this.rects = [];
  let col = [255, 255, 255];
  if (!skipCol) {
...
tetronimo.prototype.checkRow = function () {
  let rows = [[], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], []];
  if (this.down) {
...
tetronimo.prototype.update = function(){
  if (!this.down) {
    let inputs = {};
...
tetronimo.prototype.combine = function(other){
...
tetronimo.prototype.checkCollision = function(){
  for (let i = 0; i < this.rects.length; i++) {
...
tetronimo.prototype.checkRotate = function(){
  let newRects = [];
  for (let i = 0; i < this.rects.length; i++) {
...
tetronimo.prototype.checkRight = function(){
  let newRects = [];
  for (let i = 0; i < this.rects.length; i++) {
...
tetronimo.prototype.checkLeft = function () {
  let newRects = [];
  for (let i = 0; i < this.rects.length; i++) {
    newRects.push({ x: this.rects[i].x - 1, y: this.rects[i].y });
  }
...
tetronimo.prototype.rotate = function () {
  for (let i = 0; i < this.rects.length; i++) {
